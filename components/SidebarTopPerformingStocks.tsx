    ...
    <Box
      ...
      <ScrollView showsVerticalScrollIndicator={false} showsHorizontalScrollIndicator={false}>
        <VStack
          ...
          <HStack alignItems="center" justifyContent="center" space="2" pt={3}>
            <Text fontSize="xl" fontWeight="bold" _light={{ color: 'coolGray.800' }}>
              Jane Doe
            </Text>
            <IconButton
              icon={
          ...
          {list.map((item, idx) => {
            return (
              <Button
                ...
                leftIcon={
                  item.iconName === 'rupee' ? (
                    <Icon size="5" mr="2" as={FontAwesome} name={item.iconName} />
                  ) : (
      ...
      <Box px="6" py="4">
        <Button
          ...
          justifyContent="flex-start"
          py="3"
          leftIcon={<Icon size="5" mr="2" as={MaterialIcons} name="exit-to-app" />}
          _text={{
            fontSize: 'md',
            fontWeight: 'medium',
          }}
