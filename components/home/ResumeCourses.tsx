    ...
    <Box overflow="hidden" rounded="lg" width={{ base: '80', md: '334' }}>
      ...
      <HStack
          ...
          <HStack space="2" alignItems="center">
            ...
            <Avatar.Group space={-2} _avatar={{ size: 'xs' }}>
              <Avatar
                ...
                source={require('../../assets/theme/women.jpg')}
              />
              <Avatar
                _light={{ borderColor: 'coolGray.100' }}
                _dark={{ borderColor: 'coolGray.700' }}
                source={require('../../assets/theme/nice-girl.jpg')}
              />
              <Avatar
                _light={{ borderColor: 'coolGray.100' }}
                _dark={{ borderColor: 'coolGray.700' }}
                source={require('../../assets/theme/smiling.jpg')}
              />
            </Avatar.Group>
          </HStack>
        </VStack>
        ...
        <IconButton
          ...
          rounded="full"
          variant="unstyled"
          icon={<Icon as={MaterialIcons} name="play-arrow" color="coolGray.50" size={5} />}
        />
        */}
      </HStack>
    </Box>
