      ...
      <HStack space="3" alignItems="center">
        ...
        <HStack ml="auto" space="3" alignItems="center">
          <IconButton
            ...
            colorScheme="light"
            p="0"
            icon={<Icon size="6" color="coolGray.50" as={MaterialIcons} name="search" />}
          />
          <Menu
            p="0"
            trigger={(triggerProps) => {
            ...
            placement="bottom right">
            <Menu.Item _dark={{ bg: 'coolGray.900' }}>邀請</Menu.Item>
            <Menu.Item _dark={{ bg: 'coolGray.900' }}>檢視</Menu.Item>
            <Menu.Item _dark={{ bg: 'coolGray.900' }}>設定</Menu.Item>
          </Menu>
        </HStack>
      </HStack>
    </Box>
      ...
      <VStack flex={1} _light={{ bg: 'white' }} _dark={{ bg: Colors.LOGO_COLOR_WHITE_BACKGROUND }}>
        ...
        <Box
          ...
          <VStack alignItems="center" flex={1} p={{ md: 8 }}>
            <MainContent displayScreenTitle {...props} />
          </VStack>
        </Box>
      </VStack>
    </>
